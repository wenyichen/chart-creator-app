...
import { ColorPalette, AdvancedSettings, ChartData } from './types';
...
function App() {
  ...
  const handleChartCreate = async (data: ChartData, type: 'bar' | 'pie', title: string, palette: ColorPalette, settings: AdvancedSettings) => {
    setChartData(data);
    setChartType(type);
    setChartTitle(title);
    ...
    <div className="App">
      <div className="container">
        <div className="header">
          <h1>Chart Creator</h1>
          <p>Create beautiful bar and pie charts with your data</p>
        </div>
